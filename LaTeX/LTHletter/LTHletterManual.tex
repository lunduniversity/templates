\documentclass[11pt,eng,LU,logoBW]{LTHletter}
...
\end{CodeBox}
  ...
  \begin{CodeBox}{}
\documentclass[11pt,eng,LTH,logoBW]{LTHletter}
\usepackage[utf8]{inputenc}
\usepackage[T1]{fontenc}
%%%%%%%%%% Fonts
\usepackage{mathptmx}
